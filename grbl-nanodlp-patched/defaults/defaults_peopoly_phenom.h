/*
  GRBL settings for Peopoly Phenom NanoDLP conversion
...
#define defaults_h
  ...
  #define DEFAULT_X_MAX_RATE 150.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 150.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 150.0  // mm/min
  #define DEFAULT_X_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (3.0*60*60) // 10*60*60 mm/min^2 = 5 mm/sec^2
  ...
  #define DEFAULT_HOMING_SEEK_RATE 150.0 // mm/min
